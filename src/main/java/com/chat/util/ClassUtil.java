...
public class ClassUtil {
    ...
    public static Set<Method> getMethodSet(Class<?> clazz, Class annotation) {
    ...
    public static Set<Class<?>> getClassSet(String basePackage, Class annotation) {
        Set<Class<?>> classSet = getClzFromPkg(basePackage);
        ...
        while (classIterator.hasNext()) {
            ...
            for (Annotation ann : clazzAnnotations) {
